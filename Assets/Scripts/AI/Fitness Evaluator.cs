...
//		Debug.Log("Lower Playability Level:- " + lower_playabilityLevel);
		...
		//sec result = (float)(0.760666*numberOfClears + 1.0*score + 1.0*time - 0.510066*columnHeights_sum - 0.184483*columnHeights_bumpiness - 0.237753*upper_playabilityLevel - 0.118876*lower_playabilityLevel);
